...
export interface SubcategoryParamsType extends QueryOptions {
  limit?: number;
  sortedBy?: string;
  orderBy?: string;
...
export interface SubcategoryQueryOptionsType extends QueryOptions {
  type?: string;
  text?: string;
  subcategory?: string;
  status?: string;
...
export interface BannerQueryOptionsType extends QueryOptions {
  type?: string;
  text?: string;
  status?: string;
  banner?: string;
